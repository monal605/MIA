...
"""
    ...
    try:
        ...
        print("⚠️ Gemini response not in JSON format.")
        print(f"Error: {e}")
        return {}
...
def main():
    while(True) :
        print("📨 Please give me your text, press Enter twice to submit):")
        ...
        if intent.lower() == "order placement":
            ...
            try:
                ...
                print("🧠 Memory Agent Response:", mem_response.text)
            except Exception as e:
                print("❌ Memory agent error:", e)

            # Step 2.2: Extract items + quantities using Gemini
            print("\n🤖 Asking Gemini to extract items & quantities...")
            ...
            if items:
                ...
                try:
                    ...
                    print("📉 Inventory Update Response:", stock_response.text)
                except Exception as e:
            ...
            try:
                ...
                print("📄 RFQ Agent Response:", rfq_response.text)
            except Exception as e:
                print("❌ RFQ Agent Error:", e)

        elif intent.lower() == "complaint":
            print("\n⚠️ Complaint intent detected...")
            ...
            """
            try:
                print("🤖 Sending complaint to Gemini for processing...")
                ...
                print("✅ Complaint Parsed:", complaint_data)
                ...
                try:
                    ...
                    print("❌ Memory Agent Error while posting complaint:", e)

            except Exception as e:
                print("❌ Gemini failed to parse complaint:", e)

        elif intent.lower() == "invoice":
            print("\n🧾 Invoice intent detected...")
        ...
        IMPORTANT: Do not include anything else — no backticks, no markdown, no commentary. Only return the JSON.
        ...
        """
            try:
                ...
                if order_id:
                    ...
                    print("📑 Invoice Agent Response:", invoice_response.text)
                else:
                    print("⚠️ Gemini did not return a valid order ID.")
            except Exception as e:
                print("❌ Error handling invoice intent:", e)

        
        # else:
        #     print(f"ℹ️ No special routing for intent '{intent}'.")
